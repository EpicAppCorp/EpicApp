  ...
  return (
    <div key={post.id} className="rounded-3xl bg-surface p-4">
      <div className="flex gap-4">
        ...
        <div className="relative relative-row-reverse">
          <button 
          ...
          {dropdown && (
              <div className="absolute right-0 overflow-hidden rounded-xl bg-surface text-base hover:shadow-lg">
                <li>
                  <Link
                    className="grid h-11 grid-cols-12 items-center gap-2 px-4 text-white transition-colors duration-150 hover:bg-primary hover:text-black"
                    href="/profile"
                  >
                    <i className="fa-regular fa-trash col-span-2 text-white" />
                    Delete
                  </Link>
                </li>
              </div>
