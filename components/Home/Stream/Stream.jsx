        ...
        items: [
          {
            ...
            author: {
              ...
              profileImage:
                'https://api.dicebear.com/5.x/micah/svg?backgroundColor=fffd01&seed=adsadadsa',
            },
            object:
          ...
          },
          {
            ...
            actor: {
              ...
              profileImage:
                'https://api.dicebear.com/5.x/micah/svg?backgroundColor=fffd01&seed=adsa',
            },
            object: {
              type: 'author',
              id: 'http://127.0.0.1:5454/authors/9de17f29c12e8f97bcbbd34cc908f1baba40658e',
    ...
    return (
      <div className="flex flex-col">
        {inbox.data.data.items.map((item, idx) => {
          if (item.type === 'follow')
            return <FollowRequest key={item.id} follow={{ ...item, idx }} />;
          else if (item.type === 'like')
            return <Like key={item.id} like={{ ...item, idx }} />;
          else if (item.type === 'comment')
            return <Comment key={item.id} comment={{ ...item, idx }} />;
        })}
      </div>
    );
