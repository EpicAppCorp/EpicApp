    ...
    const verifyAuthor = useMutation((authorToVerify) => {
        ...
        onSuccess(data) {
            ...
            sendFollow.mutate({
                    ...
                    actor: {
                        type: "author",
                        id: authorSendingRequest.data.data.host + "api/authors/" + authorSendingRequest.data.data.id,
                        host: authorSendingRequest.data.data.host,
                        displayName: authorSendingRequest.data.data.displayName,
                        url: authorSendingRequest.data.data.host + "api/authors/" + authorSendingRequest.data.data.id,
